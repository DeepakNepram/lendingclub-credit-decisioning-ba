...
| `fico_band` | category (ordinal) | FICO tier bucket of `fico_mid`. **Formula (empirical):** bin `fico_mid` → `<660` (below policy floor, RULE-01) · `660–699` · `700–739` · `740–779` · `780+`. | **(empirical)** — the 660 policy floor is **confirmed** against the accepted distribution: the 1st and 5th percentiles of `fico_range_low` are both 660 (the evidence behind RULE-01 in the FRD). Cut points are governed by this dictionary. | **derived** |
